"""
Django settings for fsthub project.
...
WSGI_APPLICATION = 'fsthub.wsgi.application'
...
LOCALE_PATHS = [
    BASE_DIR / 'frontend/translations'
]
...
STATIC_URL = os.getenv('DJANGO_STATIC_URL', '') or f'/{os.getenv('FSTHUB_URL_PREFIX', '')}static/'
